...
<form action="{{url('do_add_menu')}}" method="post">
    <table border="1" align="center">
<tr>
    <td>菜单类型: <select name="menu_type" id="">
...
<tr>
    <td> 菜单名称:<input type="text" name="menu_name"></td>
</tr>

<tr>
    <td>二级菜单名称:<input type="text" name="second_menu_name"></td>
</tr>

<tr>
    <td>  菜单标识(标识或url)<input type="text" name="menu_tag"></td>
</tr>
