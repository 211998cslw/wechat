            ...
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('分类添加','{{url('cate_add')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>分类添加</cite></a>
                            </li>

                            <li>
                                <a onclick="xadmin.add_tab('分类列表','{{url('cate_list')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>分类列表</cite></a>
                            </li>

                            <li>
                                <a onclick="xadmin.add_tab('分类修改','{{url('cate_update')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>分类修改</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('七牛云添加','{{url('qiniu')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>七牛云添加</cite></a>
                            </li>
                            <li>
            ...
            <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                         <iframe src="{{asset('/admin/./welcome.html')}}" frameborder="0" scrolling="yes" class="x-iframe"></iframe>
                    </div>
                </div>
                <div id="tab_show"></div>
            </div>
